...
#define RHOK  6             /* volume specific turbulent kinetic energy */
#define RHOG  7             /* volume specific turbulent g */
...
#define EXT_RHOK    RHOK                       /* volume specific turbulent kinetic energy */
#define EXT_RHOG    RHOG                       /* volume specific turbulent g */
