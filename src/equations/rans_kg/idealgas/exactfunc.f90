...
USE MOD_Equation_Vars    ,ONLY: epsTKE,epsOMG,s43,s23,Cmu,Comega1,Comega2,invSigmaG
...
REAL                :: muS,muT,kPos,gPos,muTOrig,invR
! REAL                :: prodK,dissK,prodG,dissG,crossG
#if FV_ENABLED
