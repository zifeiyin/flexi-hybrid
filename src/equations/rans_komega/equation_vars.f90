...
CHARACTER(LEN=255),DIMENSION(7),PARAMETER :: StrVarNames =&
  (/ CHARACTER(LEN=255) :: 'Density','MomentumX','MomentumY','MomentumZ','EnergyStagnationDensity','DensityTKE','DensityOmega'/) !< conservative variable names
CHARACTER(LEN=255),DIMENSION(8),PARAMETER :: StrVarNamesPrim=&
  (/ CHARACTER(LEN=255) :: 'Density','VelocityX','VelocityY','VelocityZ','Pressure','Temperature','TKE','Omega'/) !< primitive variable names
